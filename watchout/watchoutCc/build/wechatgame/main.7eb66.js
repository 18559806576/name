(function () {
    ...
    function boot () {
        ...
        var bundledScript = settings.debug ? 'src/project.dev.js' : 'src/project.582ec.js';
        if (jsList) {
    ...
    if (false) {
        (function () {
            ...
            require('src/settings.01dd0.js');
            require(window._CCSettings.debug ? 'cocos2d-js.js' : 'cocos2d-js-min.ac01c.js');
    ...
    if (window.document) {
        ...
        cocos2d.async = true;
        cocos2d.src = window._CCSettings.debug ? 'cocos2d-js.js' : 'cocos2d-js-min.ac01c.js';
